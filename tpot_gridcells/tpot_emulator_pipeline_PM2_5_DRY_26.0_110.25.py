...
# Average CV score on the training set was: 0.9732098199944487
exported_pipeline = make_pipeline(
    MinMaxScaler(),
    ZeroCount(),
    OneHotEncoder(minimum_fraction=0.2, sparse=False, threshold=10),
    GaussianProcessRegressor(kernel=Matern(length_scale=4.0, nu=2.5), n_restarts_optimizer=60, normalize_y=False)
)
