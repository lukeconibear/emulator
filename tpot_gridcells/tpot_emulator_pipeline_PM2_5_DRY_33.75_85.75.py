...
# Average CV score on the training set was: 0.9899102475061744
exported_pipeline = make_pipeline(
    make_union(
        Binarizer(threshold=0.45),
        RobustScaler()
    ),
    GaussianProcessRegressor(kernel=Matern(length_scale=3.4000000000000004, nu=2.5), n_restarts_optimizer=160, normalize_y=True)
)
