...
# Average CV score on the training set was: 0.9692799374517266
exported_pipeline = make_pipeline(
    OneHotEncoder(minimum_fraction=0.25, sparse=False, threshold=10),
    GaussianProcessRegressor(kernel=Matern(length_scale=1.1, nu=2.5), n_restarts_optimizer=15, normalize_y=False)
)
